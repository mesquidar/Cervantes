        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    TargetId = table.Column<int>(type: "int", nullable: false),
                    VulnCategoryId = table.Column<int>(type: "int", nullable: false),
                    Risk = table.Column<int>(type: "int", nullable: false),
                    cve = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProofOfConcept = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Impact = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CVSS3 = table.Column<float>(type: "real", nullable: false),
                    CVSSVector = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Remediation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RemediationComplexity = table.Column<int>(type: "int", nullable: false),
                    RemediationPriority = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
